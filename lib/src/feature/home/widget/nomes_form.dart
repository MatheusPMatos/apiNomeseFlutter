        ...
        key: _formKey,
         child: Column(
          children: [
            const SizedBox(
              height: 150,
              child: Text(TextConstant.descricaoPesquisaNome, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500),)),
            const Divider(
              color: Colors.grey,
               height: 15,
               thickness: .5,
            ...
            TextFormField(
              controller: _nomeEC,
               validator: Validatorless.multiple([
                    ...
                    Validatorless.onlyCharacters('Digite apenas caracteres, sem numeros ou simbolos.'),
                    ]
                    ),
