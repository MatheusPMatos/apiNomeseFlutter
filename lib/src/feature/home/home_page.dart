          ...
          child: Column(
            ...
            children: [
              Container(
                  ...
                  child: const Center(
                      child: Text(
                    'Informações sobre nomes pelo Brasil!',
                    style: TextStyle(
                ...
                children: [
                  ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          ...
                          backgroundColor: homepageVariaveis.pesquisaNome
                              ? Colors.blue
                              : Colors.white70),
                      onPressed: () {
                        homePageMetodos.setTipoPesquisa(true);
                      },
                      child: Text("Pesquise seu Nome",
                          style: TextStyle(
                              color: homepageVariaveis.pesquisaNome
                                  ? Colors.white
                                  : Colors.black,
                              fontSize: 24))),
                  const SizedBox(
                  ...
                  ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          side: const BorderSide(color: Colors.blue, width: 1),
                          backgroundColor: homepageVariaveis.pesquisaRanking
                              ? Colors.blue
                              : Colors.white70),
                      onPressed: () {
                      ...
                      child: Text(
                        "Ranking dos Nomes",
                        style: TextStyle(
                            color: homepageVariaveis.pesquisaRanking
                                ? Colors.white
                                : Colors.black,
                            fontSize: 24),
                      ))
                ...
                child: SizedBox(
                  ...
                  child: Center(
                    child: Column(
                      children: [
                        Text(
                          homepageVariaveis.cidade != null
                              ? 'Cidade: ${homepageVariaveis.cidade!.nome}'
                              : "tests",
                        ...
                        Text(
                          homepageVariaveis.cidade != null
                              ? 'Estado: ${homepageVariaveis.cidade!.estado}'
                              : "tesata",
                          style: const TextStyle(
